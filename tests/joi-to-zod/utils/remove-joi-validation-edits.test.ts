...
import removeJoiValidationEdits from '../../../src/joi-to-zod/utils/remove-joi-validation-edits';

test('removes Joi required edits', async () => {
  const source = `
import Joi from 'joi';
...
`;
  ...
  expect(updatedSource).toMatchInlineSnapshot(`
    "import Joi from 'joi';
